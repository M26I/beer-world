...
export default function Home() {
  return (
    <>
     ...
     <h1 className='text-title-brown text-4xl md:text-6xl pl-10 pt-16'>FEW WORDS ABOUT BEER STYLES</h1>
     </div>
     <p className='pl-10 text-xl pt-10 '>The most general categorization of beer styles by yeast type is a modern craft brewing phenomenon.
        ...
        yeast and lagers if they use bottom-fermenting (lager) yeast. Most categorization systems will allow for
         a third classification, often called spontaneously-fermented because of the method; however, wild or mixed
          fermentation are perhaps more widely-used modern craft beer terms for these beers fermented with bacteria or
           ...
           <p className='pl-10 text-xl pt-10 '>In Germany and other old-world brewing centers, the terminology most typically used to differentiate beers 
            ...
            lager as a method of conditioning beer. So, Germans would typically speak of Kölsch as a top-fermented lager beer,
             ...
             <p className='pl-10 text-xl pt-10 '>English brewers, particularly when dealing in a historical context, might separate ales from porters and 
